...
-- Criação do usuário.
CREATE USER matheus WITH PASSWORD '202203047';
ALTER USER matheus WITH SUPERUSER;
...
GRANT ALL ON DATABASE uvv TO matheus;
ALTER DEFAULT PRIVILEGES
GRANT ALL ON TABLES TO matheus;
...
-- Criação dos Schemas.
CREATE SCHEMA hr AUTHORIZATION matheus;
